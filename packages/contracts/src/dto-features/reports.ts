...
export const REPORT_TYPE_DEFINITIONS: readonly ReportTypeDefinition[] = [
  ...
  { key: 'leave_report', name: 'Staff Leave Report', description: 'Per department: each employee\u2019s days of one leave type in the period and how many (Casual Leave, Sick Leave, ...).', requiredParameters: [...DATE_RANGE, 'leaveTypeCode'], optionalParameters: ['branchId', 'departmentId'], permissions: ['report.view', 'attendance.view', 'leave.view'], formats: ALL_FORMATS, status: 'planned', orientation: 'portrait', defaultFormat: 'pdf' },
