...
export const REPORT_TYPE_DEFINITIONS: readonly ReportTypeDefinition[] = [
  ...
  { key: 'monthly_attendance', name: 'Monthly Attendance Report', description: 'Employees × days of the month with the attendance code in every cell and an absence count.', requiredParameters: ['month'], optionalParameters: SCOPE, permissions: ATTENDANCE, formats: ALL_FORMATS, status: 'planned', orientation: 'landscape', defaultFormat: 'pdf' },
  { key: 'employee_attendance', name: 'Detail Report', description: 'One page per employee: every day of the period with times, hours, overtime, under time and remarks.', requiredParameters: [...DATE_RANGE, 'employeeIds'], optionalParameters: [], permissions: ATTENDANCE, formats: ALL_FORMATS, status: 'planned', orientation: 'portrait', defaultFormat: 'pdf' },
  ...
  { key: 'late_report', name: 'Staff Late Attendance Report', description: 'Per department: each employee\'s late days of the period and how many.', requiredParameters: DATE_RANGE, optionalParameters: ['branchId', 'departmentId'], permissions: ATTENDANCE, formats: ALL_FORMATS, status: 'planned', orientation: 'portrait', defaultFormat: 'pdf' },
  { key: 'absence_report', name: 'Staff Absents Monthly Report', description: 'Per department: each employee\'s absent days of the period and how many.', requiredParameters: DATE_RANGE, optionalParameters: ['branchId', 'departmentId'], permissions: ATTENDANCE, formats: ALL_FORMATS, status: 'planned', orientation: 'portrait', defaultFormat: 'pdf' },
  ...
  { key: 'missing_punch_report', name: 'Missed Punch Report', description: 'Every unpaired punch of the period, by date and department, with the time that was recorded.', requiredParameters: DATE_RANGE, optionalParameters: ['branchId', 'departmentId'], permissions: ATTENDANCE, formats: ALL_FORMATS, status: 'planned', orientation: 'portrait', defaultFormat: 'pdf' },
  ...
  { key: 'audit_report', name: 'Audit Trail Report', description: 'Who changed what: attendance edits with old and new values, or the full audit log.', requiredParameters: DATE_RANGE, optionalParameters: ['scope'], permissions: ['report.view', 'audit.view'], formats: ALL_FORMATS, status: 'planned', orientation: 'portrait', defaultFormat: 'pdf' },
