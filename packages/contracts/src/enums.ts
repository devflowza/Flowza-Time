...
export const SYNC_JOB_TYPES = ['PULL_ATTENDANCE', 'PULL_EMPLOYEES', 'PUSH_EMPLOYEE', 'PUSH_EMPLOYEES', 'DEVICE_HEALTH_CHECK', 'RECONCILIATION', 'TEST_CONNECTION', 'DELETE_EMPLOYEE'] as const;
