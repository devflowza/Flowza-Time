...
export const REPORT_TYPES = ['daily_attendance', 'monthly_attendance', 'employee_attendance', 'branch_attendance', 'department_attendance', 'late_report', 'absence_report', 'overtime_report', 'missing_punch_report', 'device_sync_report', 'device_health_report', 'audit_report', 'payroll_summary', 'employee_directory', 'leave_report', 'attendance_summary', 'weekly_attendance', 'weekly_in_out'] as const;
